...
Begin VB.Form frmBantuaneng 
   ...
   Begin VB.ListBox List1 
      ...
      ForeColor       =   &H00000000&
      Height          =   2370
      ItemData        =   "frmBantuaneng.frx":5E62
      Left            =   0
      List            =   "frmBantuaneng.frx":5E9F
      TabIndex        =   1
      Top             =   0
      Width           =   7425
   End
   Begin VB.ListBox List2 
      ...
      ForeColor       =   &H00000000&
      Height          =   4155
      ItemData        =   "frmBantuaneng.frx":6127
      Left            =   0
      List            =   "frmBantuaneng.frx":6275
      TabIndex        =   0
      Top             =   2400
      Width           =   7425
   End
   ...
   Begin VB.Image ImBantu 
      Height          =   480
      Left            =   120
      MouseIcon       =   "frmBantuaneng.frx":7B21
      Picture         =   "frmBantuaneng.frx":7E2B
      ToolTipText     =   "Bantuan"
      Top             =   6600
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmBantuaneng"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'---------------------------------------------------------------------------------------
' Nama File  : frmBantuaneng.frm
